...
<tr>
  <th width="20%"> <button type="button" class="btn btn-primary" id="addData"><span class="glyphicon glyphicon-pencil"></span> เพิ่มข้อมูลนักศึกษา</button></th>
...
<td width="50%"></td>
  ...
  <?php    $total_data =" SELECT COUNT(*) as num_row FROM tb_student ";
...
{
    $("#showmain").load("systems/symphom_insert.php");
});
 $("#show_list").load("systems/symphom_list.php");
